...
# print(controller.create_car('MuscleCar', 'Mustang', 400))
# print(controller.create_car('MuscleCar', 'Ford', 380))
# print(controller.create_car('MuscleCar', 'Chevrolet', 300))
#
# print(controller.create_driver('Tonny'))
# print(controller.create_driver('Simon'))
# print(controller.create_driver('AJ'))
#
# print(controller.create_race('Grandprix'))
# print(controller.add_car_to_driver('Simon', 'MuscleCar'))
# print(controller.add_car_to_driver('AJ', 'MuscleCar'))
# print(controller.add_car_to_driver('Tonny', 'MuscleCar'))
# print(controller.add_driver_to_race('Grandprix', 'Tonny'))
# print(controller.add_driver_to_race('Grandprix', 'Simon'))
# print(controller.add_driver_to_race('Grandprix', 'AJ'))
#
# print(controller.start_race('Grandprix'))
#
#
